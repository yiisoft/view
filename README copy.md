...
- [Basic functionality for use in any environment or Advanced functionality for use in a web environment](docs/guide/en/README.md)
- [Funcionalidade básica para uso em qualquer ambiente ou funcionalidade avançada para uso em ambiente web](docs/guide/pt-BR/README.md)

, [中国人](docs/guide/zh-CN/README.md), [Français](docs/guide/fr/README.md), [日本語](docs/guide/ja/README.md), [Português - Brasil](docs/guide/pt-BR/README.md), [Русский](docs/guide/ru/README.md), [Spanish](docs/guide/es/README.md)
